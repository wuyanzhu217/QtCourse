...
//工具栏
    ...
    actabout->setIcon(QIcon(":/images/images/BLD.BMP"));
    ui->menu->insertAction(ui->actNew,actabout);
    //QAction* actaboutbar=new QAction("关于",this);
    ui->mainToolBar->insertAction(ui->actNew,actabout);
...
{ //信号与槽的关联，当函数带有参数时，必须写明参数的类型
    connect(actabout,&QAction::triggered,this,[=](){
        ...
        QLabel*name_label=new QLabel("姓名:黄惠凯",dialog);
        QLabel*id_label=new QLabel("学号：2023414300205",dialog);
